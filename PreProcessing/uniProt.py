...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(usage="UniProt Parser")
    parser.add_argument("-P", "--uniprot", required=True, help="UniProt data file")
    parser.add_argument("-E", "--encodingpath", required=True, help="Protein-Gene output data file")
    parser.add_argument("-I", "--interactionpath", required=True, help="Protein-Protein output data file")
    parser.add_argument("-D", "--diseasepath", required=True, help="Protein-Disease output data file")
    parser.add_argument("-V", "--diseasevocabularypath", required=True, help="Disease Vocabulary data file")
    parser.add_argument("-G", "--genevocabularypath", required=True, help="Gene Vocabulary data file")
    parser.add_argument("-O", "--omimpath", required=False, help="Omim vocabulary data file")
    parser.add_argument("-C", "--chemicalpath", required=False, help="Chemical vocabulary data file")
