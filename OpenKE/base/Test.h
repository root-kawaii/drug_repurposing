...
extern "C"
void test_link_prediction(char filepath[]) {
    ...
    myfile << "no type constraint results:\n";

    myfile << "metric:\t\t\t MRR \t\t MR \t\t hit@10 \t hit@3  \t hit@1 \n";
    myfile << "l(raw):\t\t\t" << l_reci_rank << "\t\t" << l_rank << "\t\t" << l_tot<< "\t" << l3_tot << "\t" << l1_tot;
    myfile << "\n";
    myfile << "r(raw):\t\t\t" << r_reci_rank << "\t\t" << r_rank << "\t\t" << r_tot<< "\t" << r3_tot << "\t" << r1_tot;
    myfile << "\n";
    myfile << "l(filter):\t\t\t" << l_filter_reci_rank << "\t\t" << l_filter_rank << "\t\t" << l_filter_tot<< "\t" << l3_filter_tot << "\t" << l1_filter_tot;
    myfile << "\n";
    myfile << "r(filter):\t\t\t" << r_filter_reci_rank << "\t\t" << r_filter_rank << "\t\t" << r_filter_tot<< "\t" << r3_filter_tot << "\t" << r1_filter_tot;
